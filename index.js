...
client.on('interactionCreate', async (interaction) => {
    ...
    // 🔒 Hide fuzzymaster from others
    if (interaction.isChatInputCommand() &&
        interaction.commandName === 'fuzzymaster' &&
    ...
    if (interaction.isButton()) {
        ...
        if (interaction.customId.startsWith('coinflip_')) {
            ...
            const [_, userId, opponentId, amount, chosenSide] = interaction.customId.split('_');
            ...
            const winnerId = result === chosenSide ? userId : opponentId;
